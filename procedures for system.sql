...
CREATE PROCEDURE loging_walk_in_order (
    ...
    IN p_order_type ENUM('delivery', 'dine-in', 'take-out'),
...
BEGIN
    ...
    SELECT
        ...
        poi.Quantity,
        poi.Price_Per_Item
    FROM processing_order_items poi
    JOIN processing_orders po ON poi.order_ID = po.order_ID
    WHERE po.order_list_id = p_order_list_id;
END //
